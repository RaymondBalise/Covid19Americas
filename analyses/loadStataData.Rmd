...
# Info
Data from Touchton, Michael <miketouchton@miami.edu> Tuesday, April 28, 2020 at 5:21 PM  Re: Walk through demonstration of the website
...
```{r}
analysis <- read_stata("../data/covid-19 mayo 01 v2.dta", encoding = "latin1") %>% 
  ...
  mutate(`State Name` = case_when(State_Name == "MichoacÂn" ~ "Michoacan",
                                ...
                                State_Name == "Mex" ~ "Estado de Mexico",
                                TRUE ~ State_Name))
