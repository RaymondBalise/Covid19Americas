...
analysis <- read_stata("../data/Mexico COVID-19 April 15.dta") %>% 
  ...
  mutate(`State Name` = case_when(State_Name == "Michoac�n" ~ "Michoacán",
                                State_Name == "Nuevo Le�n" ~ "Nuevo León",
                                State_Name == "Quer�taro" ~"Querétaro",
                                State_Name == "San Luis Potos�" ~ "San Luis Potosí",
                                State_Name == "Yucat�n" ~ "Yucatán",
                                TRUE ~ State_Name))
